...
#download partial
mkdir prepare/datadir
python prepare/download.py --dataset jdb --datadir prepare/datadir/jdb --valid_ids 0 1 
python prepare/download.py --dataset sa1b --datadir prepare/datadir/sa1b --data_fraction 0.001 --skip_existing --num_proc 16 --max_image_size 1500
...
bash scripts/down_ucsc_parquet.sh 2
HIP_VISIBLE_DEVICES=1 python prepare/generate_fluxtotal.py --local_mds_dir prepare/datadir/mds/mds_train_512ucsc_fromflux --imgdim 512 --prompt_type ucsc --download_mode partial
HIP_VISIBLE_DEVICES=1 python prepare/generate_fluxtotal.py --local_mds_dir prepare/datadir/mds/mds_train_512diffdb_fromflux --imgdim 512 --prompt_type diffusiondb --download_mode partial
